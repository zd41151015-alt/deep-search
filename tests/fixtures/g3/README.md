...
All G3 fixtures are synthetic and unverified. The representative benchmark shape exists only to
exercise deterministic schema, lineage, aggregation, publication, and recovery mechanics. It is not
real Evidence, an executed external validation, a successful benchmark, product viability, or market
success.
