...
G0.3 consumes this bundle without modifying or republishing it. Store-internal operation receipts and the Evidence raw-content substrate are versioned mechanical records, not new formal research artifact schemas. The full Evidence Record contract remains owned by G1.2.
