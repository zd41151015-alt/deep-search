...
- 为每个 subagent 提供 typed task envelope 和唯一 staging output path；formal output path 由 task 的 `lane_submission_contract` 和 Harness publish 闭合。main agent 始终是唯一 orchestrator。
