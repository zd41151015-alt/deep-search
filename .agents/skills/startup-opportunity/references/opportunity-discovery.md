...
最终报告固定输出量化信号表、竞品/替代矩阵和 coverage gap 表。每条量化信号显示 metric definition、地域、周期、measurement type、可比性和 uncertainty；排名、评分人数、下载、MAU、收入估算和付费人数保持不同语义，跨地域/周期/类别/口径不可直接横比。
