...
| G3 AI Bundle Construction | `IN_PROGRESS` | G2 | G3.1 caller-supplied baseline/reliability/data contract 已实现；同一 worker继续 G3.2-G3.3，Stage末形成一次 clean candidate preflight |
